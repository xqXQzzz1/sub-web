...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "herokuapp(自用)": "https://xqxsub.herokuapp.com/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://xqxsub.herokuapp.com/sub?" },
  ...
  mounted() {
    ...
    this.form.remoteConfig = "https://raw.githubusercontent.com/xqXQzzz1/clashpref/main/OwnSSR_remote.ini";
